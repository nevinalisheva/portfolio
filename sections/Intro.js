...
const Introduction = () => {
    return (
      <div className="flex flex-col sm:flex-row sm:h-screen mb-10 sm:mb-0  items-center " id="intro">
          ...
          <div>
            <div className="py-10">
              ...
              <h1 className="text-3xl font-semibold ">
                I am{" "}
                <span className="text-purple-300 dark:text-violet-300 tracking-wider">Nevin </span>
